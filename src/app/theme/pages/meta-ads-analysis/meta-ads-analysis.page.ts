...
import type { MetaAdsAnalysisPageIO } from './meta-ads-analysis.io';
import { mockMetaAdsAnalysisPageIO } from './meta-ads-analysis.io';
import type { MetaAdsAnalysisFormValue } from './meta-ads-analysis.vm';
import { sampleMetaAdsAnalysisFormValue } from './meta-ads-analysis.vm';

type MetaAdsAnalysisField = keyof MetaAdsAnalysisFormValue;
type MetaAdsAnalysisForm = FormGroup<{
  accountId: FormControl<string>;
  dateRange: FormControl<MetaAdsAnalysisFormValue['dateRange']>;
  objective: FormControl<MetaAdsAnalysisFormValue['objective']>;
}>;
      ...
      <form [formGroup]="form" (ngSubmit)="runAnalysis()">
        ...
        >
          ...
          <st5-button-block
            ...
            [text]="state === 'running' ? 'Running...' : 'Run Meta analysis'"
          />
        </st5-analysis-form-pattern>
      </form>
...
export class St5MetaAdsAnalysisPage {
  @Input()
  io: MetaAdsAnalysisPageIO = mockMetaAdsAnalysisPageIO;

  protected state: AnalysisResultViewModel['state'] = 'idle';
  protected result: AnalysisResultViewModel['result'] = null;
  protected rawOutput = 'Run the form to call /api/meta-ads-analysis.';
  protected submitAttempted = false;
  protected readonly form: MetaAdsAnalysisForm;
